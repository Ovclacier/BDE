@extends('layout')
    ...
    <div class = "container-fluid container blc text-center">
            ...
            <div class="row blc menuTop">
                <a class="btn btn-success" href="{{ route('events.create') }}"style="margin-top:10px; margin-bottom:10px;"> Create New Event</a>
</div>
    ...
    <table>
        ...
        <div class="row blc menuTop">
				...
				<a href="{{ route('events.show', $event->id) }}"><img src="img/party.jpg" alt="" width="200" height="200" alt="pile"></a>
				</div>
